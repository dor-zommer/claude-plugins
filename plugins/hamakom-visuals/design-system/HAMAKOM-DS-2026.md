...
| קיקר קאבר (= ה-lede!) | IBM Plex | SemiBold | 28 | — (letter-spacing 2, sc-terra) |
| byline קאבר (שם בלבד) | IBM Plex | Medium | 25 | — (ink-soft) |
...
| CTA שורה 1 | IBM Plex | Medium | 42 | — |
| CTA שורה 2 ("בלי בולשיט") | Suez One | Regular | 76 | 110% |
| כפתור CTA | IBM Plex | Bold | 34 | — |
| url בפוטר CTA (רצועת שנהב) | IBM Plex | Bold | 24 | — (letter-spacing 4) |
...
- **הקיקר מעל הכותרת = ה-lede** (משפט תקציר הכתבה) בטרקוטה-בהיר `--sc-terra` —
  IBM Plex SemiBold 28, letter-spacing 2. **אין תגית קטגוריה בקאבר.**
...
- **byline = שם הכותב/ת בלבד** (בלי "כתבה ·" / "מאת:") — IBM Plex Medium 25,
  **ink-soft `#6b6a63`**.
...
- שורה 1: "בלי בעלי הון.  בלי פרסומות." — **IBM Plex Medium 42** שנהב, ממורכז, y≈720.
- שורה 2: "בלי בולשיט" — **Suez One 76** שנהב, ממורכז, y≈790.
- כפתור pill **טרקוטה** `#D97757` (400×108, radius 54, ממורכז, y≈970) עם "לכתבה המלאה" — IBM Plex Bold 34 **בשנהב**.
- פוטר: **רצועת שנהב ברוחב מלא** (56px, y=1294) עם `HA-MAKOM.CO.IL` בדיו — IBM Plex Bold 24, letter-spacing 4, ממורכז. בלי לוגו קטן, בלי פס תחתון.
